...
def num(choice):
    if choice == 1:
        ...
        return f"The cubic volume of width = {width} length = {length} and height = {height} is {cubic}"
    elif choice == 3:
        base = float(input("Please enter the base diameter : "))
        height = float(input("Please enter the height : "))
        conical = ((1/3)*(22/7)*((base/2)**2)*(height))
        return f"The conical volume of cone with diameter = {base} and height = {height} is {conical}"
    else:
        return "Invalid Choice"

print("Please enter a choice for your selection:")
print("Enter 1 if you want to calculate the area of a triangle.")
print("Enter 2 if you want to calculate the volume of a cubic.")
print("Enter 3 if you want to calculate the volume of a cone.") 
